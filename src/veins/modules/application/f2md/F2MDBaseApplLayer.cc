...
void F2MDBaseApplLayer::initialize(int stage)
{
...
simtime_t F2MDBaseApplLayer::computeAsynchronousSendingTime(simtime_t interval, ChannelType chan)
{
...
void F2MDBaseApplLayer::populateWSM(BaseFrame1609_4* wsm, LAddress::L2Type rcvId, int serial)
{
...
void F2MDBaseApplLayer::receiveSignal(cComponent* source, simsignal_t signalID, cObject* obj, cObject* details)
{
    Enter_Method_Silent();
...
void F2MDBaseApplLayer::handlePositionUpdate(cObject* obj)
{
...
void F2MDBaseApplLayer::handleLowerMsg(cMessage* msg)
{
...
void F2MDBaseApplLayer::handleSelfMsg(cMessage* msg)
{
    getSimulation()->getActiveEnvir()->alert("WARNING F2MDBaseApplLayer::handleSelfMsg");
...
F2MDBaseApplLayer::~F2MDBaseApplLayer()
{
...
void F2MDBaseApplLayer::startService(Channel channel, int serviceId, std::string serviceDescription)
{
...
void F2MDBaseApplLayer::stopService()
{
    cancelEvent(sendWSAEvt);
    currentOfferedServiceId = -1;
}

void F2MDBaseApplLayer::sendDown(cMessage* msg)
{
    checkAndTrackPacket(msg);
    BaseApplLayer::sendDown(msg);
}

void F2MDBaseApplLayer::sendDelayedDown(cMessage* msg, simtime_t delay)
{
    checkAndTrackPacket(msg);
    BaseApplLayer::sendDelayedDown(msg, delay);
}

void F2MDBaseApplLayer::checkAndTrackPacket(cMessage* msg)
{
