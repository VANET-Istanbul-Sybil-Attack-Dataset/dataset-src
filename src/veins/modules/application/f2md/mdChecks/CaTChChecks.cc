...
double CaTChChecks::ProximityPlausibilityCheck(const veins::Coord* testPosition, const veins::Coord* myPosition, const veins::Coord* myHeading)
{
...
double CaTChChecks::RangePlausibilityCheck(const veins::Coord* receiverPosition,
...
double CaTChChecks::PositionConsistancyCheck(const veins::Coord* curPosition,
...
double CaTChChecks::PositionSpeedMaxConsistancyCheck(const veins::Coord* curPosition,
    const veins::Coord* curPositionConfidence, const veins::Coord* oldPosition,
...
double CaTChChecks::PositionSpeedConsistancyCheck(const veins::Coord* curPosition,
    const veins::Coord* curPositionConfidence, const veins::Coord* oldPosition,
    const veins::Coord* oldPositionConfidence, double curSpeed,
    double curSpeedConfidence, double oldspeed, double oldSpeedConfidence,
    double time)
...
double CaTChChecks::SuddenAppearenceCheck(const veins::Coord* receiverPosition,
    const veins::Coord* receiverPositionConfidence, const veins::Coord* senderPosition,
    const veins::Coord* senderPositionConfidence)
{
    double distance = mdmLib.calculateDistancePtr(senderPosition,
...
double CaTChChecks::PositionPlausibilityCheck(const veins::Coord* senderPosition,
...
void CaTChChecks::KalmanPositionSpeedConsistancyCheck(const veins::Coord* curPosition,
...
void CaTChChecks::KalmanPositionSpeedScalarConsistancyCheck(const veins::Coord* curPosition,
    const veins::Coord* oldPosition, const veins::Coord* curPositionConfidence, const veins::Coord* curSpeed,
...
double CaTChChecks::KalmanPositionConsistancyCheck(const veins::Coord* curPosition,
...
double CaTChChecks::KalmanPositionAccConsistancyCheck(const veins::Coord* curPosition,
