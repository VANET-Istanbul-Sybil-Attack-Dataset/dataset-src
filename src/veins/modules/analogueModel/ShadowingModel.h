...
class VEINS_API ShadowingModel : public AnalogueModel {
protected:
...
public:
    ShadowingModel(cComponent* owner, bool useTorus, const Coord& playgroundSize, double dist0, double std_db, double pathlossExp);
    ...
    double ns2_shadowing(Signal* signal);
